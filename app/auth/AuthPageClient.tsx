        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 9999,
              border: 'none',
              backgroundColor: submitting || googleSubmitting ? '#7dd3fc' : '#0284c7',
              color: '#ffffff',
              fontSize: 14,
              fontWeight: 600,
              cursor: submitting || googleSubmitting ? 'default' : 'pointer',
              boxShadow: '0 12px 30px rgba(8,47,73,0.35)',
            }}
          >
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 9999,
              border: '1px solid #e5e7eb',
              backgroundColor: googleSubmitting || submitting ? '#f3f4f6' : '#ffffff',
              color: googleSubmitting || submitting ? '#9ca3af' : '#0f172a',
              fontSize: 14,
              fontWeight: 600,
              cursor: googleSubmitting || submitting ? 'default' : 'pointer',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              gap: 8,
